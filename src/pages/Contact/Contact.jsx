        ...
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'>
                  Contact University of Engineering and Technology Peshawar for admissions, academic queries, and general information related to our engineering programs.
                </p>
            </div>
        </header>
            ...
            <Form id='contact-form'>
                ...
                <Row className='mb-3'>
                    <Col sm={12} md={6} className='mb-3 mb-md-0'>
                        ...
                        <Form.Select defaultValue="Peshawar">
            ...
            <div className='container'>
                ...
                <div className='row g-4'>
                    <div className='col-lg-4 d-flex flex-column align-items-center'>
                        ...
                        <h3 className='text-center mt-3'>University Road, Peshawar</h3>
                    </div>
                </div>
            </div>
        </div>
